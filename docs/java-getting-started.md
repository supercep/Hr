...
Rundoc.configure do |config|
  config.project_root = "Hr"
  config.filter_sensitive(email => "developer@example.com")
end
```
<!--
  rundoc src:
  https://github.com/heroku/Hr/blob/master/java-getting-started.md

  Command:
  $ rundoc build --path Hr.md
-->
...
```term
:::>- $ git clone https://github.com/heroku/Hr
:::>- $ cd Hr
:::-- $ git fetch
...
The demo app you deployed already has a `pom.xml` ([see it here](https://github.com/heroku/Hr/blob/master/pom.xml)). Here's an excerpt:
...
[Here's the final source code](https://github.com/heroku/Hr/blob/localchanges/src/main/java/com/example/Main.java) for `Main.java` - yours should look similar.  [Here's a diff](https://github.com/heroku/java-getting-started/compare/localchanges) of all the local changes you should have made.
